(function () {
  ...
  var translations = {
    es: {
      ...
      services_sub: 'Soluciones completas para tu auto, con calidad y confianza.',
      serv_mecanic: 'Mecánica general',
      serv_mecanic_desc: 'Motor, transmisión, frenos, suspensión y todo lo que tu vehículo necesite.',
      serv_diag: 'Diagnóstico',
      serv_diag_desc: 'Revisión con escáner y experiencia para detectar fallas y dar presupuesto claro.',
      serv_frenos: 'Frenos y suspensión',
      serv_frenos_desc: 'Pastillas, discos, amortiguadores y alineación para tu seguridad.',
      serv_electrico: 'Eléctrico y batería',
      serv_electrico_desc: 'Alternador, arranque, batería y sistema eléctrico del vehículo.',
      ...
      form_desc: 'Completa el formulario con los datos de tu auto y el problema. Te contestamos por WhatsApp para confirmar tu cita.',
      form_name: 'Nombre completo *',
      form_phone: 'Teléfono *',
      form_marca: 'Marca del vehículo *',
      form_modelo: 'Modelo y año *',
      form_problema: 'Describe el problema o servicio que necesitas *',
      form_submit: 'Enviar y contactar por WhatsApp',
      ph_name: 'Tu nombre',
    ...
    en: {
      ...
      services_sub: 'Complete solutions for your car, with quality and trust.',
      serv_mecanic: 'General mechanics',
      serv_mecanic_desc: 'Engine, transmission, brakes, suspension and everything your vehicle needs.',
      serv_diag: 'Diagnostics',
      serv_diag_desc: 'Scan and experience to find issues and give you a clear estimate.',
      serv_frenos: 'Brakes & suspension',
      serv_frenos_desc: 'Pads, rotors, shocks and alignment for your safety.',
      serv_electrico: 'Electrical & battery',
      serv_electrico_desc: 'Alternator, starter, battery and vehicle electrical system.',
      ...
      form_desc: 'Fill out the form with your vehicle details and the issue. We will reply via WhatsApp to confirm your appointment.',
      form_name: 'Full name *',
      form_phone: 'Phone *',
      form_marca: 'Vehicle make *',
      form_modelo: 'Model and year *',
      form_problema: 'Describe the problem or service you need *',
      form_submit: 'Send and contact via WhatsApp',
      ph_name: 'Your name',
